...
clas=pd.read_csv(r'C:\Users\hp\Desktop\Birds Model\classname.csv')
class_names=list(clas.Class_Name)

# define a Flask app

MODEL = load_model(r'C:\Users\hp\Desktop\Birds Model\Birds_model_15_Epoch_new.h5',custom_objects={'KerasLayer': hub.KerasLayer})
